...
public class db {
	...
	// private String sConnStr = "jdbc:microsoft:sqlserver://localhost:1433;databasename=ssmxxmsgglxthsg6085AHB6"; 
	 
	 private String dbDriver="com.mysql.jdbc.Driver";
	 private String sConnStr = "jdbc:mysql://localhost:3306/ssmxxmsgglxthsg6085AHB6?useUnicode=true&amp;amp;amp;amp;amp;characterEncoding=gb2312"; 
	
	 // private String dbDriver="net.sourceforge.jtds.jdbc.Driver";
	// private String sConnStr = "jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=ssmxxmsgglxthsg6085AHB6"; 
	 ...
	 private List list;
	  ...
	  public List getShouyebht(){
		...
		public String getddnr(String nuser){
			...
			String sql = "select shangpinmingcheng,goumaishuliang from gouwuche where goumairen = '"+nuser+"' and issh='否' ";
			System.out.print(sql);

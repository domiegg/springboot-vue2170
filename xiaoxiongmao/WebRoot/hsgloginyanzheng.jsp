...
<html>
 ...
 if(cx.equals("游客")){sql="select * from yonghu where yonghuming='"+uid+"' and mima='"+pwd+"' and quanxian='游客'";}
  if(cx.equals("会员")){sql="select * from yonghu where yonghuming='"+uid+"' and mima='"+pwd+"' and quanxian='会员'";}
 //quxanxiaxndexnglxu

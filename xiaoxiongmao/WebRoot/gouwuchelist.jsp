...
<form action="gwcList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shangpinbianhao}</td>    <td>${u.shangpinmingcheng}</td>    <td>${u.jiage}</td>    <td>${u.goumaishuliang}</td>    <td>${u.zongjia}</td>    <td>${u.goumairen}</td>    
                              ...
                              <td align="center"><a href="gwcDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="gwcList.do?page=1" >首页</a>
             <a href="gwcList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="gwcList.do?page=${page.page+1 }">下一页</a>
			<a href="gwcList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>

	...
	<body>
			<form action="updateDingdan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.dingdanbianhao.value='${dingdan.dingdanbianhao}';</script>	<script language="javascript">document.form1.neirong.value='${dingdan.neirong}';</script>	<script language="javascript">document.form1.goumairen.value='${dingdan.goumairen}';</script>	<script language="javascript">document.form1.zongjine.value='${dingdan.zongjine}';</script>	<script language="javascript">document.form1.lianxishouji.value='${dingdan.lianxishouji}';</script>	<script language="javascript">document.form1.songhuodizhi.value='${dingdan.songhuodizhi}';</script>	<script language="javascript">document.form1.beizhu.value='${dingdan.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
